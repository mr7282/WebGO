...
var CommentWhere = struct {
	...
	DeletedAt: whereHelpertime_Time{field: "`Comments`.`deleted_at`"},
}
...
var (
	commentAllColumns            = []string{"ID", "user_id", "comment", "created_at", "updated_at", "deleted_at"}
	commentColumnsWithoutDefault = []string{"user_id", "comment", "updated_at", "deleted_at"}
