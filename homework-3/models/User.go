...
var UserWhere = struct {
	...
	Telephone: whereHelperstring{field: "`User`.`telephone`"},
...
type userR struct {
	UserPosts PostSlice `boil:"UserPosts" json:"UserPosts" toml:"UserPosts" yaml:"UserPosts"`
}
...
var (
	userAllColumns            = []string{"ID", "name", "email", "telephone", "created_at", "updated_at", "deleted_at"}
	userColumnsWithoutDefault = []string{"name", "email", "telephone", "updated_at", "deleted_at"}
...
// UserPosts retrieves all the post's Posts with an executor via user_id column.
func (o *User) UserPosts(mods ...qm.QueryMod) postQuery {
...
// LoadUserPosts allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadUserPosts(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	if singular {
		object.R.UserPosts = resultSlice
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.UserID {
				local.R.UserPosts = append(local.R.UserPosts, foreign)
				if foreign.R == nil {
					foreign.R = &postR{}
				}
...
// AddUserPosts adds the given related objects to the existing relationships
// of the User, optionally inserting them as new records.
// Appends related to o.R.UserPosts.
// Sets related.R.User appropriately.
func (o *User) AddUserPosts(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Post) error {
	var err error
	...
	if o.R == nil {
		...
		o.R.UserPosts = append(o.R.UserPosts, related...)
	}
